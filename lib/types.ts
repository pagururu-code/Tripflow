...
export type ItemType = 'flight'|'place'|'manual';
...
export interface InboxItem { id:string; tripId:string; title:string; duration:number; type:ItemType; priority:number; address?:string; location?:LatLng; openingHours?:string[]; mapUrl?:string; note?:string; }
