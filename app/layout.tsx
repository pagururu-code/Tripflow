...
import PlaceTypeBackfill from '@/components/PlaceTypeBackfill';
import './globals.css';
...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="ko"><body>{children}<InboxOrganizer/><PlaceHoursEnhancer/><PlaceTypeBackfill/><ShareTripButton/></body></html>}
