...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="ko"><body>{children}<InboxOrganizer/><PlaceHoursEnhancer/><PlaceMetadataHydrator/><PlaceSearchResultStyle/><ShareTripButton/></body></html>}
